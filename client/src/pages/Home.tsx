...
//   return (
//     <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-16">
//       {/* Keep Featured Categories Swiper As Is */}
//       <section>
//         <h2 className="text-3xl font-bold text-gray-900 mb-8">
//           Featured Categories
//         </h2>
...
//               <div
//                 className="relative h-72 rounded-xl overflow-hidden cursor-pointer group"
//                 onClick={() => navigate(`/recipes/mealtype/${category.name}`)}
//               >
//                 <img
//                   src={category.image || '/placeholder.svg'}
//                   alt={category.name}
...
//         {/* Focus Cards for Each Cuisine */}
//         <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mb-12">
//           {cuisineTypes.map((cuisine) => (
//             <div
//               key={cuisine}
//               className="relative bg-gray-100 rounded-lg shadow-md overflow-hidden cursor-pointer transform transition-all duration-300 hover:scale-105"
//               onClick={() => navigate(`/recipes/cuisine/${cuisine}`)}
//             >
//               <img
//                 src={`/images/${cuisine.toLowerCase()}.jpg`} // Ensure images exist for cuisines
//                 alt={cuisine}
...
//         {/* Display Recipes Under Each Cuisine */}
//         <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
//           {Object.entries(cuisineRecipes).map(([cuisine, recipes]) => (
//             <div key={cuisine} className="space-y-4">
//               <h3 className="text-xl font-semibold text-gray-800">
...
//                 alt={cuisine}
//                 className="w-full h-full object-cover transition-transform duration-300 group-hover:scale-210"
//               />

//               {/* Cuisine Name (Hidden Initially, Visible on Hover) */}
...
//       {/* All Recipes - Horizontal Scroll Section */}
//       <section>
//         <h2 className="text-3xl font-bold text-gray-900 mb-4">All Recipes</h2>
//         <div className="flex items-center justify-between mb-4">
//           <p className="text-gray-600">Explore all our delicious recipes</p>
//           <button
...
//               <div
//                 key={recipe.recipe_id}
//                 className="bg-white rounded-lg shadow-lg w-64 flex-shrink-0 overflow-hidden cursor-pointer transition-transform duration-300 hover:scale-105"
//                 onClick={() => navigate(`/recipes/${recipe.recipe_id}`)}
//               >
//                 <img
//                   src={recipe.image || '/images/default-recipe.jpg'}
      ...
      {selectedMealType && (
        <section>
          ...
          <div className="text-center mt-6">
            <button
              onClick={() => navigate(`/recipes/meal-type/${selectedMealType}`)}
