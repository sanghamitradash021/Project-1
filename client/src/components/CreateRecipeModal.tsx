...
interface CreateRecipeModalProps {
  ...
  onClose: () => void;
  /**
   * Function to be called when recipe creation is successful.
   */
  onSuccess: () => void;
}
...
/**
 * Component to handle the creation of a recipe.
 *
 * @param {CreateRecipeModalProps} props - The component's props.
...
const CreateRecipeModal: React.FC<CreateRecipeModalProps> = ({
  ...
  /**
   * Handles image file selection and upload to Cloudinary.
   *
  ...
  /**
   * Handles form submission for creating a recipe.
   *
