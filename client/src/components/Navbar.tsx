...
//  *
//  * @interface SearchResult
//  * @property {number} id - The unique ID of the recipe.
//  * @property {string} title - The title of the recipe.
//  * @property {string} description - A brief description of the recipe.
//  * @property {string} image - URL to the image representing the recipe.
//  */
// interface SearchResult {
//   id: number;
//   title: string;
...
//   /**
//    * Effect hook that retrieves the username from session storage when the location changes.
//    */
//   useEffect(() => {
//     let user = sessionStorage.getItem('username');
//     setUsername(user);
...
//   /**
//    * Callback function for handling a successful recipe creation.
//    */
//   const handleCreateRecipeSuccess = () => {
//     // Refresh the recipe list or show a success message
//     // You can implement this based on your needs
...
//   /**
//    * Navigates to the "My Recipes" page.
//    */
//   const handleMyRecipesClick = () => {
//     navigate('/my-recipes');
//     setIsDropdownOpen(false); // Close the dropdown after selecting My Recipes
